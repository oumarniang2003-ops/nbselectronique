const PRODUCTS = [
  ...
  // ===== RÉFRIGÉRATEURS SMART TECHNOLOGY =====
  {
    id: "smart-str-345m",
    ...
    features: [
      "Double porte avec congélateur en haut",
      "Technologie No Frost (zéro givre)",
      "Tropicalisé pour le climat chaud (classe T)",
      "Éclairage LED intérieur",
      "Design inox gris anthracite"
    ],
    specs: {
      "Modèle": "STR-345M",
      "Marque": "Smart Technology",
      "Type de froid": "No Frost",
      "Classe climatique": "T (Tropicalisé)",
      "Couleur": "Gris inox",
      "Garantie": "1 An"
    },
    featured: true
  },
  {
    ...
    features: [
      "Combiné : réfrigérateur haut + congélateur bas",
      "Froid ventilé intégral",
      "Étagères en verre trempé",
      "Grand bac à légumes",
      "Tropicalisé pour les hautes températures"
    ],
    specs: {
      "Modèle": "STCB-270M",
      "Marque": "Smart Technology",
      "Type": "Combiné (congélateur bas)",
  ...
  },
  {
    ...
    features: [
      "Grande capacité combinée",
      "Congélateur bas avec tiroirs",
  ...
  },
  {
    ...
    features: [
      "Distributeur d'eau fraîche intégré",
      "Grande capacité 459 Litres",
      "Froid No Frost intégral",
      "Écran digital de température",
      "Design premium gris anthracite"
    ],
    specs: {
      "Modèle": "STCB-459WM",
      "Marque": "Smart Technology",
      "Capacité": "459 Litres",
      "Fonctionnalité": "Distributeur eau",
      "Couleur": "Gris anthracite",
      "Garantie": "1 An"
    },
    featured: true
  },
  {
    ...
    features: [
      "Très grande capacité 557 Litres",
      "Congélateur bas avec 4 tiroirs séparés",
    ...
    specs: {
      ...
      "Marque": "Smart Technology",
      "Capacité": "557 Litres",
      "Type congélateur": "Multi-tiroirs",
      "Garantie": "1 An"
    },
    featured: false
  },
  {
    ...
    features: [
      "Double porte compacte",
      "Congélateur en haut",
      "Économique en électricité",
      "Bacs à légumes spacieux",
      "Finition inox argenté"
    ],
    specs: {
      "Modèle": "STR-160H",
      "Marque": "Smart Technology",
  ...
  // ===== RÉFRIGÉRATEURS ROCH =====
  {
    ...
    features: [
      "325 Litres – 4 tiroirs spacieux",
      "Fabriqué en Turquie (qualité européenne)",
      "Classe énergétique A++",
      "Froid ventilé No Frost",
  ...
  },
  {
    ...
    features: [
      "160 Litres – 3 tiroirs",
      "Garantie compresseur 12 ans",
      "Technologie Nature Fresh",
      "Refroidissement 4 dimensions",
      "Design inox élégant"
    ],
    specs: {
      "Modèle": "RFR-160B-B",
      "Marque": "Roch",
      "Capacité": "160 Litres",
      "Compresseur": "Garantie 12 ans",
      "Technologie": "Nature Fresh",
      "Garantie": "1 An + compresseur"
    },
    featured: false
  },
  {
    ...
    features: [
      "290 Litres – 4 tiroirs",
      "Fontaine d'eau fraîche intégrée",
      "Technologie Nature Fresh",
      "Compresseur durable et silencieux",
    ...
    specs: {
      ...
      "Marque": "Roch",
      "Capacité": "290 Litres",
      "Fonctionnalité": "Fontaine eau intégrée",
      "Tiroirs": "4",
      "Garantie": "2 Ans"
    },
    featured: true
  ...
  // ===== VITRINE RÉFRIGÉRÉE =====
  {
    ...
    features: [
      "Porte vitrée transparente",
      "Éclairage LED intérieur",
      "Étagères réglables en verre",
      "Compresseur silencieux professionnel",
      "Capacité de stockage commerciale"
    ],
    specs: {
      "Modèle": "STCDV-890",
      "Marque": "Smart Technology",
  ...
  // ===== CONGÉLATEURS =====
  {
    ...
    features: [
      "Technologie Fast Cooling (refroidissement rapide)",
      "Couvercle isolant haute performance",
      "Panier de rangement suspendu",
      "Tropicalisé pour le climat chaud",
      "Réglage de température mécanique"
    ],
    specs: {
      "Marque": "Smart Technology",
      "Type": "Coffre horizontal",
      "Capacité": "~100 Litres",
      "Classe climatique": "T (Tropicalisé)",
      "Garantie": "1 An"
    },
  ...
  },
  {
    ...
    features: [
      "Grande capacité pour familles nombreuses",
      "Double vitrage intérieur",
      "Panier de rangement amovible",
      "Serrure de sécurité à clé",
      "Isolation thermique renforcée (autonomie coupure 36h)"
    ],
    specs: {
      "Marque": "Smart Technology",
      "Type": "Coffre horizontal grand modèle",
      "Isolation": "36h sans courant",
      "Classe climatique": "T (Tropicalisé)",
      "Garantie": "1 An"
    },
    featured: true
  ...
  // ===== MACHINES À LAVER SMART =====
  {
    ...
    features: [
      "Lavage cyclonique puissant",
      "Double cuve (lavage + essorage séparés)",
      "Capacité 8 kg en lavage",
    ...
    specs: {
      ...
      "Marque": "Smart Technology",
      "Capacité": "8 kg",
      "Type": "Semi-automatique double cuve",
      "Garantie": "1 An"
    },
    featured: true
  },
  {
    ...
    features: [
      "Capacité 7 kg",
      "Couvercle transparent bleu",
      "Double cuve efficace",
  ...
  // ===== MACHINE À LAVER ROCH =====
  {
    ...
    features: [
      "Moteur Inverter garanti 10 ans",
      "Classe énergétique A+++",
      "Lavage rapide Quick Wash 15 min",
      "1400 tours/minute",
      "Programmes : Coton, Jean, Synthétique, Laine, Délicat"
    ],
    specs: {
      "Modèle": "RWM-80SI-H",
      "Marque": "Roch",
      "Capacité": "8 kg",
      "Vitesse essorage": "1400 RPM",
      "Classe": "A+++",
      "Garantie": "2 Ans (moteur 10 ans)"
    },
    featured: true
  },
  ...
  // ===== VENTILATEURS =====
  {
    ...
    features: [
      ...
      "18 pouces de diamètre pour un brassage maximal",
      "3 vitesses avec oscillation auto",
      "Hauteur réglable",
      "Panneau de commande intégré sur le pied"
    ],
    specs: {
      "Modèle": "RSF-1804-D",
      "Marque": "Roch",
  ...
  // ===== MICRO-ONDES =====
  {
    ...
    features: [
      "Capacité 20 litres",
      "Puissance réglable (plusieurs niveaux)",
      "Minuterie jusqu'à 30 minutes",
      "Fonction décongélation",
      "Porte à charnière solide avec poignée"
    ],
    specs: {
      "Marque": "Enduro",
      "Capacité": "20 Litres",
  ...
  // ===== FER À REPASSER =====
  {
    ...
    features: [
      "Semelle céramique anti-adhérente",
      "Vapeur continue puissante",
...
// Delivery locations in Dakar and their fees in FCFA
const DAKAR_SHIPPING_ZONES = {
  "plateau-fass": { name: "Dakar Plateau / Médina / Fass / Colobane", fee: 1500 },
  "almadies-yoff": { name: "Almadies / Ngor / Yoff / Ouakam / Mermoz", fee: 2000 },
  "grand-dakar": { name: "Grand Dakar / HLM / Sicap Liberté / Dieuppeul", fee: 1500 },
  "parcelles": { name: "Parcelles Assainies / Patte d'Oie / Grand Yoff", fee: 2000 },
  "guediawaye-pikine": { name: "Guédiawaye / Pikine / Keur Massar", fee: 2500 },
  "rufisque": { name: "Rufisque / Bargny / Sangalkam", fee: 3500 },
  "diamniadio": { name: "Diamniadio / Sebikotane", fee: 5000 }
};
